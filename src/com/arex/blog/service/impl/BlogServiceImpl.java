...
//		Blog blog = convertBlogVO2POForUpdate(blogDTO);
	...
	@Override
	public List<BlogDTO> searchDeletedBlogByCategoryIdAndUserId(HttpServletRequest request, String categoryId, String userId) {
		String hqlWhere = " where 1=1 and o.deleteSign = 1 ";
		List<Object> paramList = new ArrayList<Object>();
		if (categoryId != null && !"".equals(categoryId)) {
			hqlWhere += " and o.categoryId=? ";
			paramList.add(categoryId);
	...
	@Override
	public List<BlogDTO> searchDeletedBlogByCategoryIdAndUserId(String categoryId, String userId) {
		String hqlWhere = " where 1=1 and deleteSign = 1 ";
		List<Object> paramList = new ArrayList<Object>();
		if (categoryId!=null && !"".equals(categoryId)) {
			hqlWhere += " and categoryId=? ";
	...
	@Override
	public int searchDeletedBlogCountsByCategoryIdAndUserId(String categoryId,String userId) {
		List<BlogDTO> blogDTOList = this.searchDeletedBlogByCategoryIdAndUserId(categoryId, userId);
		return blogDTOList.size();
	}
